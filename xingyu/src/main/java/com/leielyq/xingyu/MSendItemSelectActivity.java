...
public class MSendItemSelectActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (menuItemId == R.id.nav_search) {
            ...
            Integer msocre = Integer.parseInt(socre.getText().toString());
