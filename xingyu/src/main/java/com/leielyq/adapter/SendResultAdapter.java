 ...
 */
public class SendResultAdapter extends RecyclerView.Adapter<SendResultAdapter.ViewHolder> {
    private List<MResult> mdata;

    public SendResultAdapter(List<MResult> mdata) {
        this.mdata = mdata;
    }
